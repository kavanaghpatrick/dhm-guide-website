...
// lazy-imports './Compare.modern.jsx' — vi.mock is hoisted and intercepts that
// dynamic import, so the test never executes the real modern page.
vi.mock('../Compare.jsx', () => ({
  default: () => <div data-testid="control-page">CONTROL compare</div>,
}))
...
vi.mock('../Compare.modern.jsx', () => {
  const ModernPage = () => {
    ...
    return <div data-testid="modern-page">MODERN compare</div>
  }
  return { default: ModernPage }
})

const FLAG_KEY = 'compare-modern-v1'
...
describe('CompareRoute', () => {
  ...
  it('shows the CONTROL page (never a blank spinner) while the modern chunk is loading', () => {
    ...
    // mounted. The fallback is <Compare /> — so a 'modern'-bucketed visitor sees
