...
// lazy-imports './Home.modern.jsx' — vi.mock is hoisted and intercepts that
// dynamic import, so the test never executes the real modern page.
vi.mock('../Home.jsx', () => ({
  default: () => <div data-testid="control-page">CONTROL home</div>,
}))
...
vi.mock('../Home.modern.jsx', () => {
  const ModernPage = () => {
    ...
    return <div data-testid="modern-page">MODERN home</div>
  }
  return { default: ModernPage }
})

const FLAG_KEY = 'home-modern-v1'
...
describe('HomeRoute', () => {
  ...
  it('shows the CONTROL page (never a blank spinner) while the modern chunk is loading', () => {
    ...
    // mounted. The fallback is <Home /> — so a 'modern'-bucketed visitor sees real
    // control content during load, never a blank screen.
