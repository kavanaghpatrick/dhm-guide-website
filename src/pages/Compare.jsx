...
export default function Compare() {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      servings: 1,
      dhm: "Proprietary blend",
      purity: "Clinical formula",
      badge: "88.89% Effective",
      badgeColor: "bg-green-500",
      score: 8.2,
      affiliateLink: "https://amazon.com/good-morning-hangover-pills",
      dhmPerDollar: "Unknown",
      additionalIngredients: ["Electrolytes", "Liver Support Complex", "B-Vitamins"],
      thirdPartyTested: false,
      moneyBackGuarantee: true,
      shippingSpeed: "Prime 1-2 days",
      manufacturingLocation: "USA",
    ...
    },
    {
      ...
      score: 8.6,
      affiliateLink: "https://amazon.com/dhm1000-dihydromyricetin",
      dhmPerDollar: 33.4,
    ...
    },
    {
      ...
      badgeColor: "bg-blue-500",
      score: 8.8,
      affiliateLink: "https://amazon.com/dhm-depot-dihydromyricetin",
      dhmPerDollar: 6.7,
